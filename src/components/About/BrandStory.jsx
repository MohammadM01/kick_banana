    ...
    <div className="brand-story-section">
      <div className="brand-story-grid">
        <div className="brand-story-text">
          ...
          <p>
            KICKINBANANA started with a simple belief: football and cricket jerseys shouldn't cost a fortune to be premium. As die-hard sports enthusiasts ourselves, we noticed the market was filled with overpriced, generic kits that lose their shine after a few matches, or poorly fitting replicas.
          </p>
          <p>
        ...
        <div className="brand-story-graphic">
          <div className="story-visual-card">
            {/* Clipart/Illustration vector look */}
            <svg viewBox="0 0 120 120" fill="none" className="story-svg">
              ...
              {/* Crossed bats/sports elements */}
              <line x1="30" y1="90" x2="90" y2="30" stroke="var(--primary)" strokeWidth="4" strokeLinecap="round" />
              <line x1="35" y1="90" x2="85" y2="40" stroke="var(--accent)" strokeWidth="2" strokeLinecap="round" />
